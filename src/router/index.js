    ...
    children: [
      {
        path: 'case7',
        name: 'case7',
        component: () => import('@/views/case7/echartsdemo'),
        meta: { title: 'case7-图表', icon: 'table' }
      },
      {
        path: 'demo1',
        name: 'Demo1',
      ...
      },
      {
        path: 'case1',
        name: 'Case1',
        component: () => import('@/views/case1/case1'),
        meta: { title: 'Case1', icon: 'tree' }
      },
      {
        path: 'case2',
        name: 'Case2',
      ...
      },
      {
        path: 'case8',
        name: 'Case8',
        component: () => import('@/views/case8/case8'),
        meta: { title: 'Case8', icon: 'edittable' }
      }
    ]
  },
